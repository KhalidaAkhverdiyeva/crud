      ...
      <div className="flex items-center gap-[100px]">
        ...
        <ul className="flex gap-[50px] font-[400] text-[16px]">
          <li>
            <a
              href="/home"
              className={` hover:text-[#E3411A] transition-colors duration-400 ${
                pathname === "/home" ? "text-[#E3411A]" : "text-black"
              }`}
            >
              Blog
            </a>
          ...
          <li>
            <a
              href="/products"
              className={` hover:text-[#E3411A] transition-colors duration-400 ${
                pathname === "/products" ? "text-[#E3411A]" : "text-black"
              }`}
            >
              Products
            </a>
          ...
          <li>
            <a
              href="/contact"
              className={` hover:text-[#E3411A] transition-colors duration-400 ${
                pathname === "/contact" ? "text-[#E3411A]" : "text-black"
              }`}
            >
              Contact
            </a>
          ...
          <li>
            <a
              href="/about"
              className={` hover:text-[#E3411A] transition-colors duration-400 ${
                pathname === "/about" ? "text-[#E3411A]" : "text-black"
              }`}
            >
              About
            </a>
          ...
          <li>
            <a
              href="/services"
              className={` hover:text-[#E3411A] transition-colors duration-400 ${
                pathname === "/services" ? "text-[#E3411A]" : "text-black"
              }`}
            >
              Services
            </a>
